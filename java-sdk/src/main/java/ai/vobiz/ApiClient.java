...
import ai.vobiz.auth.Authentication;
import ai.vobiz.auth.HttpBasicAuth;
import ai.vobiz.auth.HttpBearerAuth;
import ai.vobiz.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.vobiz.ai";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKeyAuthID", new ApiKeyAuth("header", "X-Auth-ID"));
        authentications.put("ApiKeyAuthToken", new ApiKeyAuth("header", "X-Auth-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.vobiz.ai)
     ...
     * @return a {@link ai.vobiz.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.vobiz.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.vobiz.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.vobiz.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.vobiz.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.vobiz.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.vobiz.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.vobiz.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.vobiz.ApiException If fail to serialize the request body object into a string
     */
