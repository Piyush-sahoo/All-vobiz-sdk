...
[assembly: InternalsVisibleTo("Vobiz.Test")]
...
namespace Vobiz.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string ApiKeyHeaderToString(ApiKeyHeader value)
        {
            return value switch
            {
                ApiKeyHeader.X_Auth_ID => "X-Auth-ID",
                ApiKeyHeader.X_Auth_Token => "X-Auth-Token",
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.vobiz.ai";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.vobiz.ai";
