...
inputSpec: vobiz-openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{1774F59F-D89B-4056-9437-77535D1A4E09}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiV1AccountAccountIdBalanceINRGetApiResponse apiResponse = await api.ApiV1AccountAccountIdBalanceINRGetAsync("todo");
...
- appName: Vobiz API
- appVersion: 1.0.0
- appDescription: Complete Vobiz API collection covering all endpoints: Calls, Conferences, Recordings, Account, Phone Numbers, Applications, Endpoints, Trunks, Sub-Accounts, and CDR.  Base URL: https://api.vobiz.ai  Authentication: All requests require X-Auth-ID and X-Auth-Token headers.
